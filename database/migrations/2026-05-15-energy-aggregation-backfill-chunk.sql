-- Safer chunked backfill for MySQL Workbench.
-- Change these two values and run this file repeatedly by day or by smaller ranges.
SET @backfill_from = '2026-05-13 00:00:00';
SET @backfill_to = '2026-05-14 00:00:00';
...
FROM (
    ...
    WHERE em.measured_at >= @backfill_from
      AND em.measured_at < @backfill_to
) ranked
WHERE ranked.rn = 1
